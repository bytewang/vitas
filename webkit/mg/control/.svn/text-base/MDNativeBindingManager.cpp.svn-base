...
static inline  WebCore::String JSStringRefToString(JSStringRef propertyName) 
{
  return  WebCore::String(JSStringGetCharactersPtr(propertyName));  
}

typedef HashMap<WebCore::String, void*> InterfacePropertyObject;
                    ...
                    JSStringRef propertyName, JSNativeInterface *interface) 
{
        ...
        */
        ...
        JSObjectRef object;
        WebCore::String identName = JSStringRefToString(propertyName);
