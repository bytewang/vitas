...
MDWebBackForwardList* MDWebBackForwardList::createInstance(PassRefPtr<BackForwardList> backForwardList)
{
	MDWebBackForwardList* instance = new MDWebBackForwardList(backForwardList);
	return instance;
}

	MDWebBackForwardList::MDWebBackForwardList(PassRefPtr<BackForwardList> backForwardList)
