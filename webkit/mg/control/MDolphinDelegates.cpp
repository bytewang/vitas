/*
 ** $Id: MDolphinDelegates.cpp 562 2011-03-28 08:07:45Z zjwang $
 **
...
#if ENABLE(SSL)
BOOL (*MDCB_PROVIDE_CLIENT_CERT) (CERT_DATA **x509, SSL_PKEY **evpKey, const CERT_NAME **certNames, int count);
int (*MDCB_VERIFY_SERVER_CERT) (int x509result, CERT_DATA *x509);
#endif
