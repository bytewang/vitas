...
extern "C" {
    ...
    unsigned int mdGetCacheCapacity (void)
    {
        ...
        cache()->getCapacities(0, 0, &totalBytes);
        return totalBytes;
    }
    ...
    unsigned int mdSetCacheCapacity (unsigned int totalBytes)
    {
        ...
        cache()->getCapacities(0, 0, &oldCapacity);
        cache()->setCapacities(0, totalBytes, totalBytes);
