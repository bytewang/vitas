...
#if defined(ENABLE_SSLFILE) && ENABLE_SSLFILE
...
/**
 * \var typedef void SSL_PKEY
 * \brief A type definition for SSL_PKEY.
 */
typedef void SSL_PKEY;

/**
 * \var typedef void CERT_DATA
 * \brief A type definition for CERT_DATA.
 */
typedef void CERT_DATA; 

/**
 * \var typedef void CERT_NAME
 * \brief A type definition for CERT_NAME.
 */
typedef void CERT_NAME;

/**
 * \var typedef int CERT_RESULT
 * \brief A type definition for CERT_RESULT.
 */
...
#define CWS_MODAL            0x40
    ...
    /*
     * The following 2 API (MDCB_PROVIDE_CLIENT_CERT, MDCB_VERIFY_SERVER_CERT) will not be implemented.
     * Becasue we all use CA file for SSL now.
     */

    /**
     * \fn BOOL (*MDCB_PROVIDE_CLIENT_CERT) (CERT_DATA **cert, SSL_PKEY **pkey, 
     ...
     */
    BOOL (*MDCB_PROVIDE_CLIENT_CERT) (CERT_DATA **cert, SSL_PKEY **pkey, 
                const CERT_NAME **names, int count);

    /**
     * \fn CERT_RESULT (*MDCB_VERIFY_SERVER_CERT) (CERT_RESULT result, CERT_DATA *cert)
     ...
     */
    CERT_RESULT (*MDCB_VERIFY_SERVER_CERT) (CERT_RESULT result, CERT_DATA *cert);
#endif
